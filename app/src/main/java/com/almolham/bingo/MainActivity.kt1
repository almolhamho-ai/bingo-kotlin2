...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // استرجاع آخر IP كتبه المستخدم بالمرة السابقة (لو موجود)
    ...
    private fun startJoin() {
        ...
        // حفظ الـ IP حتى يظهر تلقائياً بالمرة الجاية (يقدر يغيّره وقت ما بدو)
        getSharedPreferences("bingo_prefs", MODE_PRIVATE).edit().putString("last_ip", ip).apply()
    ...
    // إرسال أي رسالة عالشبكة لازم يصير بخيط منفصل، مش بالخيط الرئيسي (UI)
    // وإلا أندرويد بيكرش التطبيق فوراً (NetworkOnMainThreadException)
